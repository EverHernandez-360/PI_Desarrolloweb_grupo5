...
const migrate = async () => {
    const queries = [
        ...
        SELECT '202100001', 'Ana', 'Lopez', 'ana.sis@usac.edu.gt',
        '$2a$10$zenLQnuvtxu4rsDcYFjN8ugqd61N.ibyvJXUE.eb9iOEOtr5KNHdO'
        WHERE NOT EXISTS (SELECT 1 FROM usuarios WHERE email = 'ana.sis@usac.edu.gt')`,
        `INSERT INTO usuarios (registro_academico, nombres, apellidos, email, password_hash)
        SELECT '202100002', 'Luis', 'Perez', 'luis.dev@usac.edu.gt',
        '$2a$10$zenLQnuvtxu4rsDcYFjN8ugqd61N.ibyvJXUE.eb9iOEOtr5KNHdO'
        ...
        SELECT u.id, 'curso', 1, 'IPC2 me parecio muy util para reforzar logica.'
